...
class Encoder_M(nn.Module):
    def __init__(self):
        ...
        # resnet = torch.hub.load('zhanghang1989/ResNeSt', resnest_name, pretrained=True) #marked
...
class EMN(nn.Module):
    ...
    def Soft_aggregation(self, ps, K): #batch_size基
    ...
    # def Soft_aggregation(self, ps, K,batch_size=1): #num_obj基
    ...
    def segment(self, frame, imsk_1st_qtr, keys, values, num_objects):
